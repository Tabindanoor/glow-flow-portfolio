...
const Experience = () => {
  ...
  id="experience"
  ref={sectionRef}
  className="py-12 sm:py-20 bg-gradient-to-b from-dark to-dark/95"
>
...
{/*           
  ...
  >
    {/* Branch node */}
    <div className="hidden sm:block absolute left-1/2 transform -translate-x-1/2 w-4 h-4 rounded-full bg-neon-purple shadow-[0_0_15px_rgba(155,93,229,0.5)]" />

    {/* Branch line */}
    <div 
      className={`hidden sm:block absolute left-1/2 h-1 bg-neon-purple/30 ${
        index % 2 === 0 
          ? '-translate-x-full w-[calc(50%-1rem)]' 
          : 'w-[calc(50%-1rem)]'
      }`}
    ...
    {/* Content card */}
    <Card 
      className={`w-full sm:w-[calc(50%-2rem)] p-6 neon-card hover:scale-105 transition-transform duration-300 ${
